...
Historical V01 approvals for the defective downstream chain remain part of immutable provenance, but the failed cross-layer audit supersedes their use as valid production ancestry. Repaired Layer 06 and repaired Final must still be independently approved sequentially.
